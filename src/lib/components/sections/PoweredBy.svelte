<script lang="ts">
	import internetComputerText from '$lib/assets/internetComputerText.svg';
</script>
...
>
	...
	<div class="lg:text-lg text-lg font-normal max-w-7xl lg:leading-normal">
		...
		(Service Neuron System). Through integration with the SNS, the FuelDAO application will evolve
		into a DAO (Decentralized Autonomous Organization) with tokenized governance functionality,
		paving the way for a decentralized and community-driven ecosystem.
	</div>
</section>
